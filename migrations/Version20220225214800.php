 ...
 */
final class Version20220225214800 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE candidat (id INT AUTO_INCREMENT NOT NULL, userid_id INT NOT NULL, cvname VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_6AB5B47158E0A285 (userid_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE recruteur (id INT AUTO_INCREMENT NOT NULL, userid_id INT NOT NULL, entreprise VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_2BD3678C58E0A285 (userid_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
